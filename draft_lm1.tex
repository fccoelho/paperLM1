...
the health care systems of many developing countries such as Brazil. 
...
each epidemic/outbreak. In the lower panel, we see the posterior distribution 
...
median line. 
Scatter plot shows the observed cases. Prevalences (y-axes) are scaled as 
fractions of the entire population.
}
\label{Fig:S0}
\end{figure}
