...
We employ these methods to analyze Dengue incidence time series for the city of 
Rio de Janeiro from 1996 to 2014.
...
If \rr is to be used as a decision tool, howeve, one needs to be able to 
quantify the 
...
not being exposed to the disease. But, as we can see in figure xx\todo{add 
