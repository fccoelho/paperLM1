...
It is also important to consider other sources of uncertainty impinging on the 
estimation of the AR of a dengue epidemic. 
...
Depending on surveillance structure it is estimated that for every case 
reported, up to 10-20 are not seen by health authorities (personal 
communication).
%LM: Best to name who gave that. Oswaldo perhaps?
Another source of uncertainty is under-reporting, which is a serious issue in
the health care systems of many underdeveloped countries such as Brazil. 
...
%LM: Since this paragraph pretty much deals with possible limitations we may 
% want to move it to the discussion. see #14
...
new serotypes, an intrinsically stochastic events, can drastically change the 
pool of susceptibles, throwing off any sequential estimation based on the 
incidence dynamics.
...
seroprevalence and the exact behavior of the force of infection through time, we
