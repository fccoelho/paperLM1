...
a serious issue in Brazil. Duarte and Fran\c{c}a\cite{duarte_data_2006}, estimated 
...
For the fitting procedure the time series were divided into epidemic windows 
that corresponded to significant raises in incidence and normalized to lie on 
the $[0,1]$ interval.

Also, as the numerical integration routine needs $\beta(t)$ to be continuous, we 
used linear interpolation to obtain values of $R_t$ for any time point.
