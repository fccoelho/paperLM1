...
\\
Flavio Code\c{c}o Coelho$^{1}$, 
Luiz Max de Carvalho$^{2}$, 
Author3$^{3,\ast}$
\\
\bf{1} School of Applied Mathematics, Get\'ulio Vargas Foundation (FGV), Rio de Janeiro -- RJ, Brazil.
\\
\bf{2} Program for Scientific Computing (PROCC), Oswaldo Cruz Foundation, Rio de Janeiro -- RJ, Brazil.
\\
